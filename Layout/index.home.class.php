...
<html><head><title><?php echo $title; ?></title><link rel="stylesheet" href="CSS/common.css"> </head><body>   <?php   }                
        ...
        $user_data = file_get_contents("Database/user.json");
...
@file_put_contents("Database/user.json",$put_data);
echo "<center> <h4 style='color:chocolate;'> Now, You had set default account </h4><br><br></center>";
        }else{
          ...
          $_SESSION["level"] = $level;
                ...
                if($level == "teacher"){
            echo "<center><form action='teacher.php'><input type='submit' style='background-color:green; color:white; padding:10px;'value=' Go to Teacher Home Page >>' name='teacher'></form></center> ";
            
        }//teach
                if($level == "student"){
                    echo "<center><form action='student.php'><input type='submit' style='background-color:green; color:white; padding:10px;'value=' Go to Student Home Page >>' name='teacher'></form></center> ";
            
        }//stu
                if($level == "admin"){
                    echo "<center><form action='admin.php'><input type='submit' style='background-color:green; color:white; padding:10px;'value=' Go to Admin box >>' name='teacher'></form></center> ";
                   ...
                   echo "<center> <h4 style='color:hotpink;'> You must set all fields ! ' </h4><br><br></center>";
